...
cluster.setupMaster = function(options) {
  ...
  // 告诉v8将每个进程的配置文件写入一个单独的文件
  // 没有--logfile=v8这个参数，所有内容都保存着一个不能使用的文件中
  ...
  // 监听nodejs内部消息 internalMessage 是否有NODE_DEBUG_ENABLED这个命令
  // 如果有
